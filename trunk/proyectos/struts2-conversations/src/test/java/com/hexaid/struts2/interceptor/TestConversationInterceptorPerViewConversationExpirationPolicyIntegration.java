...
public class TestConversationInterceptorPerViewConversationExpirationPolicyIntegration
	...
	public void testConversationTimeoutWhenModifiedInDispatchResult() {
		try {
			...
			// modified in the result part inside the xml file
			assertEquals(20, conversation.getMaxInactiveInterval());
		} catch (Exception e) {
			e.printStackTrace();
	...
	/**
	 * Test that the conversation timeout is modified in the Redirect result type
	 * TODO: Resolver el problema de este TEST!
	 */
//	@Test
//	@Config(actionName="beginConvWithExpirationRedirect")
//	public void testConversationTimeoutWhenModifiedInRedirectResult() {
//		try {
//			String result = actionProxy.execute();
//			assertEquals(ActionSupport.SUCCESS, result);
//
...
//	}	
	...
	/**
	 * Test that the conversation timeout is modified in the RedirectAction result type
	 * TODO: Resolver el problema de este TEST!
	 */
//	@Test
//	@Config(actionName="beginConvWithExpirationRedirectAction")
//	public void testConversationTimeoutWhenModifiedInRedirectActionResult() {
//		try {
//			String result = actionProxy.execute();
//			assertEquals(ActionSupport.SUCCESS, result);
//
...
//	}	
	 ...
	 */
	@Test
	@Config(actionName="beginConvWithExpirationTiles")
	public void testConversationTimeoutWhenModifiedInTilesResult() {
		try {
			// set up Tiles
			servletContext.addInitParameter("org.apache.tiles.impl.BasicTilesContainer.DEFINITIONS_CONFIG", "tiles.xml");
			StrutsTilesListener listener = new StrutsTilesListener();
	...
	public void testForegroundConversationNotExpiredButBackgroundExpired() {
		try {
			...
			// now FORCE NOTH conversations to expire, by setting the lastAccessTime to 2 
			// minutes before
			conversation.setLastAccessTime(conversation.getLastAccessTime() - (120*1000));
